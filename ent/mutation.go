...
func (m *TweetMutation) SetTweet(s string) {
	m.tweet = &s
}

// Tweet returns the value of the "tweet" field in the mutation.
func (m *TweetMutation) Tweet() (r string, exists bool) {
	v := m.tweet
	if v == nil {
		return
	}
...
// OldTweet returns the old "tweet" field's value of the Tweet entity.
// If the Tweet object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *TweetMutation) OldTweet(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldTweet is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldTweet requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldTweet: %w", err)
	}
	return oldValue.Tweet, nil
}

// ResetTweet resets all changes to the "tweet" field.
func (m *TweetMutation) ResetTweet() {
	m.tweet = nil
}
...
func (m *TweetMutation) SetAuthorID(id string) {
	m.author = &id
}
...
func (m *TweetMutation) AuthorID() (id string, exists bool) {
	if m.author != nil {
...
func (m *TweetMutation) Fields() []string {
	...
	if m.tweet != nil {
		fields = append(fields, tweet.FieldTweet)
	}
	if m.created_at != nil {
